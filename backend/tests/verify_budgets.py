...
if __name__ == "__main__":
    ...
    print("Test Summary:")
    print("=" * 50)
    print("• Budget 50:  Expected INFEASIBLE (min is ~$167)")
    print("• Budget 100: Expected INFEASIBLE (min is ~$167)")
    print("• Budget 150: Expected INFEASIBLE (min is ~$167)")
    print("\nNote: Minimum budget for 11 players is ~$167")
    print("      (Current cheapest valid team combination)")
